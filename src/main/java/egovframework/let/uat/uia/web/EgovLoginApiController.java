...
public class EgovLoginApiController {
	...
	public HashMap<String, Object> actionLogin(@RequestBody LoginVO loginVO, HttpServletRequest request) throws NoSuchAlgorithmException {
	...
	public HashMap<String, Object> actionLoginJWT(@RequestBody LoginVO loginVO, HttpServletRequest request, ModelMap model) throws NoSuchAlgorithmException {
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
