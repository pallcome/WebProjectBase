...
public class SnsLoginApiController {
    ...
    public HashMap<String, Object> getKakaoAuthCallback(HttpServletResponse response, HttpServletRequest request) throws UnsupportedEncodingException, JsonMappingException, JsonProcessingException {
    ...
    public HashMap<String, Object> getNaverAuthCallback(HttpServletResponse response, HttpServletRequest request) throws UnsupportedEncodingException, JsonMappingException, JsonProcessingException {
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
		//네이버 로그인 인증 시작
