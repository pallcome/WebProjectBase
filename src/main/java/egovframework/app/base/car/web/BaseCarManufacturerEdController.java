 ...
 *   수정일      수정자           수정내용
 *  -------    --------    ---------------------------
 *  2025.04.03  양민우     최초 생성
 *
 * </pre>
 */
@RequestMapping("/base/car/manufacturer/edit")
@Controller
public class BaseCarManufacturerEdController extends AbstractController {
