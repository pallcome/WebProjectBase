 ...
 */
@Slf4j
@Service("BaseCarCarTypeService")
public class BaseCarCarTypeServiceImpl extends AbstractServiceImpl implements BaseCarCarTypeService {
	@Resource(name = "BaseCarCarTypeDAO")
	private BaseCarCarTypeDAO baseCarCarTypeDAO;
	/**
	 * 목록 조회
	 */
	@Override
	public List<Map<String, Object>> selectList(Map<String, Object> paramMap) {
		return baseCarCarTypeDAO.selectList(paramMap);
	}
	/**
	 * 조회
	 */
	...
	public Map<String, Object> select(Map<String, Object> paramMap) {
		return baseCarCarTypeDAO.select(paramMap);
	}
	/**
	 * 저장
	 */
	...
	public void save(Map<String, Object> paramMap) {
		baseCarCarTypeDAO.merge(paramMap);
	}
	/**
	 * 삭제
	 * @throws IOException 
