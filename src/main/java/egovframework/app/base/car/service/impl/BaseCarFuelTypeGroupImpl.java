 ...
 */
@Slf4j
@Service("BaseCarFuelTypeGroupService")
public class BaseCarFuelTypeGroupImpl extends AbstractServiceImpl implements BaseCarFuelTypeGroupService {
	@Resource(name = "BaseCarFuelTypeGroupDAO")
	private BaseCarFuelTypeGroupDAO baseCarFuelTypeGroupDAO;
	...
	public List<Map<String, Object>> selectList(Map<String, Object> paramMap) {
		return baseCarFuelTypeGroupDAO.selectList(paramMap);
	}
	/**
	 * 조회
	 */
	...
	public Map<String, Object> select(Map<String, Object> paramMap) {
		return baseCarFuelTypeGroupDAO.select(paramMap);
	}
	/**
	 * 저장
	 */
	...
	public void save(Map<String, Object> paramMap) throws IOException {
		...
		baseCarFuelTypeGroupDAO.merge(paramMap);
	}
	/**
	 * 삭제
	 * @throws IOException 
	...
	public void delete(Map<String, Object> paramMap) throws IOException {
		for(Map<String, Object> item : (List<Map<String, Object>>)paramMap.get("list")) {
			// 첨부파일
			egovFileMngService.deleteFile(item);
			
			baseCarFuelTypeGroupDAO.delete(item);
		}
	}
}