 ...
 *   수정일      수정자           수정내용
 *  -------    --------    ---------------------------
 *  2025.04.28  양민우     최초 생성
 *
 * </pre>
 */
@RequestMapping("/evaluation/result/mapping")
@Controller
public class EvaluationResultMappingLsController extends AbstractController {
	...
	public String page(Model model) {
		...
		// 자동차 그룹
		model.addAttribute("carGroupList", evaluationResultService.selectCarGroupList());
		// 시험년도
	...
	public Map<String, Object> selectList(@RequestBody Map<String, Object> paramMap) {
		return makeDataTable(evaluationResultService.selectMappingList(paramMap));
	}
}
