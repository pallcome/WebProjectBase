 ...
 *
 */
@RequestMapping("/evaluation/item/carinairtest/edit")
@Controller
public class EvaluationItemCarinairtestEdController extends AbstractController {
	...
	public Map<String, Object> selectList(@RequestBody Map<String, Object> paramMap) {
		paramMap.put("UP_TEST_ARTCL_CD", "AIR");
